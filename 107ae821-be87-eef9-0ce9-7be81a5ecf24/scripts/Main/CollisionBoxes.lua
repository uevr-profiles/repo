...
function UpdateWeaponCollisionZones(pawn, WeaponMesh , MagSocketString1,MagSocketString2)
	...
	if not string.find(CurrWpnBP1:get_full_name(),"TactiNav") then
...
local function UpdatePlayerCollisionZones(dpawn)
	...
	if BoxCompHmdRightHip ~=nil and UEVR_UObjectHook.exists(BoxCompHmdRightHip) then
		...
		UEVR_UObjectHook.get_or_add_motion_controller_state(BoxCompHmdRightHip):set_location_offset(Vector3f.new(-20,70,-10)) -- x=LeftRigth, y = Up down, Z=Forward Backwards
	...
	if BoxCompHmdChestRight~=nil and UEVR_UObjectHook.exists(BoxCompHmdChestRight) then
		...
		UEVR_UObjectHook.get_or_add_motion_controller_state(BoxCompHmdChestRight):set_location_offset(Vector3f.new(-20,25,-5)) --x=LeftRigth,y = Up down, Z= Forward Backwards
	...
	if BoxCompHmdLeftHip ~=nil and UEVR_UObjectHook.exists(BoxCompHmdLeftHip) then
		...
		UEVR_UObjectHook.get_or_add_motion_controller_state(BoxCompHmdLeftHip):set_location_offset(Vector3f.new(20,70,-10)) -- x=LeftRigth, y = Up down, Z= Forward Backwards
