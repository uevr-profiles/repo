...
--Read Gamepad stick input 
	...
	if cpawn~=nil  then
		if Abutton and cpawn.CharacterMovement~=nil then
			cpawn.CharacterMovement.MaxWalkSpeed = 600 
		elseif not Abutton and math.abs(ThumbLY)<5000 and cpawn.CharacterMovement~=nil then
			cpawn.CharacterMovement.MaxWalkSpeed = 300
		end
	end
...
uevr.sdk.callbacks.on_pre_engine_tick(
	...
	--Player.bShowMouseCursor=true
		...
		if not BodyVisibilityChecked then
